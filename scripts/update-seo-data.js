...
const updated = current
  ...
  .replace(/const DEFAULT_FALLBACK_STATS = \{ subscribers: \d+, views: \d+, videos: \d+ \};/, `const DEFAULT_FALLBACK_STATS = { subscribers: ${subs}, views: ${views}, videos: ${videos} };`)
  .replace(/const DEFAULT_FALLBACK_STATS = \{ subscribers: \d+, views: \d+, videos: \d+ \};/g, `const DEFAULT_FALLBACK_STATS = { subscribers: ${subs}, views: ${views}, videos: ${videos} };`);
